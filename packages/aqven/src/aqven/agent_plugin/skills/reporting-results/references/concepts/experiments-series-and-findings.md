...
into the metric. How a series decides explains the intervals behind all
five verdicts.
...
- How a series decides: intervals, margins, repeats and judges in plain
  words.
- The engineering loop: where experiments sit between finding a cause and
  shipping a fix.
- Experiments reference and [Findings reference](../reference/findings.md): every
  key of both files.
