# How to follow and read a series in Studio

Find a series on the Series tab, follow it live, approve its spend or stop it, and read its verdict, variants × metrics matrix, stability and cases down to each attempt's run.
...
[How to read a series](../engine/read-a-series.md). This page covers where it sits on the screen.
...
- [How to read a series](../engine/read-a-series.md): what each verdict means and what to do next.
- How to use Research in Studio: the experiment page a series belongs to.
- How to work with cases in Studio: where a look over selected cases starts.
- How to respond to a human-review request: the reviews an attempt can
  wait on.
