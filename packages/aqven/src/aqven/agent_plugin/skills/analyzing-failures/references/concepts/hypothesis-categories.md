...
- [In short](#in-short)
- [Not every failure is a hypothesis](#not-every-failure-is-a-hypothesis)
- [Categories and claim templates](#categories-and-claim-templates)
- [Which hypothesis first](#which-hypothesis-first)
- [One claim, one check](#one-claim-one-check)
- [Writing the hypothesis down](#writing-the-hypothesis-down)
  - [Example](#example)
...
- [How an agent takes a task to a reliable flow](../mcp-cli/research-loop.md): where hypotheses sit in the loop.
- [Scanning the literature before you test](literature-scan.md): where outside evidence comes in.
- The validity gate: the checklist before a series.
- How to write an experiment: every key of `experiment.yaml`.
- Experiments, series and findings: the four kinds of factor.
