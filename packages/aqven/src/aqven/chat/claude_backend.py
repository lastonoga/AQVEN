...
def create_claude_chat(project_root: Path, mcp_token: SecretStr) -> ClaudeChat:
    ...
    runtime = ClaudeChatRuntime(
        ...
        options=ClaudeOptionsFactory(ClaudeChatSettings(mcp_token=mcp_token, cli_path=cli.path)),
