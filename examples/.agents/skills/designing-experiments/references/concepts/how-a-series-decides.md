...
- [Which interval](#which-interval)
- [The verdict: the interval against the margin](#the-verdict-the-interval-against-the-margin)
- [How many cases](#how-many-cases)
- [The noise floor](#the-noise-floor)
- [Judges](#judges)
- [A failure or an infrastructure error](#a-failure-or-an-infrastructure-error)
- [See also](#see-also)
...
- [Experiments, series and findings](experiments-series-and-findings.md): working and held-out
  cases, findings and spend.
- How to read a series: what to do after each verdict.
- [How to write an experiment](../engine/experiments.md): where the margin, the guardrails and `validated_by`
  are written.
