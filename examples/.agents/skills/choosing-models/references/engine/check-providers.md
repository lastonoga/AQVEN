...
[What happens when a model is called](../concepts/what-happens-when-a-model-is-called.md)). Seeing that
...
- [What happens when a model is called](../concepts/what-happens-when-a-model-is-called.md) — the repair
...
- [How to set up a model provider](../integrations/model-providers.md) — getting credentials for a provider
