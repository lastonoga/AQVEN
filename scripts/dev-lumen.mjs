...
const pythonRoot = resolve(root, 'aqven-py')
const lumenRoot = resolve(pythonRoot, 'examples/lumen')
const studioRoot = resolve(root, 'apps/studio')
const aqven = resolve(pythonRoot, '.venv/bin/aqven')
const watchfiles = resolve(pythonRoot, '.venv/bin/watchfiles')
...
async function startStack() {
  ...
  backend = spawn(watchfiles, [
    ...
    command,
    resolve(pythonRoot, 'packages/aqven/src'),
    resolve(pythonRoot, 'packages/aqven-llm/src'),
    lumenRoot,
