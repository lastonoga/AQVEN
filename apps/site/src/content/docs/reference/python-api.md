...
`def create_mcp_server(root: 'Path', *, engine: 'EngineFacade | None' = None, write: 'bool' = True, python: 'str' = '/Users/kirunya/Projects/my/ai-workflows-automate/.worktrees/aqven-docs-example-fixes/.venv/bin/python') -> 'MCPServer'`
