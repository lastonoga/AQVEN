...
- **Unknown is not no.** A missing answer must never pass a claim. On a control case, "no answer" is not
  ...
  [Answer, refusal and unknown](/concepts/answer-refusal-and-unknown/).
...
- [Cases that can answer the question](/concepts/case-construction/): where the truth and the controls come
  from.
- [The validity gate](/concepts/validity-gate/): the checklist before a series.
- [How a series decides](/concepts/how-a-series-decides/): intervals, margins, judges and the noise floor.
- [How to write a custom evaluator](/engine/custom-evaluator/): a check of your own.
