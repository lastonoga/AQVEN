---
title: Scanning the literature before you test
description: Before you rank hypotheses, look up what is already known about the riskiest assumptions — where to search, what to write down, how to mark what nobody has confirmed, and why the web is a source for the domain but never for the engine.
---
...
[research journal](/concepts/research-journal/).
...
from the documentation of that version and from `{{CLI_COMMAND}} check`, whose messages name the fix.
...
- Learn the engine from its own documentation and `{{CLI_COMMAND}} check`, never from web summaries.

## See also

- [Hypotheses by category](/concepts/hypothesis-categories/): how a scan result turns into a claim.
- [Cases that can answer the question](/concepts/case-construction/): public datasets and derived labels.
- [The research journal](/concepts/research-journal/): where open questions live between sessions.
