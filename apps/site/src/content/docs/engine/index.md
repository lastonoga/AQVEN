---
title: Engine
description: Write workflows as files — nodes, prompts, experiments, and the CLI that checks and runs them.
---
...
The sidebar groups this area into four parts. **Node kinds** is one how-to page per kind of step.
