...
description: When a built-in check can't express what you need, write your own evaluator. This page shows the one function signature every check shares and a worked example from the showcase project.
---

## When you need this

[Built-in policies](/reference/built-in-policies/) has eleven ready-made evaluators, among them
