...
export const launchPlanOf = (plan: ApiLaunchPlan): LaunchPlan => ({
  request: { on: plan.on, cases: plan.cases, repeats: plan.repeats },
  variants: plan.variants,
  attempts: plan.attempts,
  available: plan.available,
  halfWidth: plan.half_width,
  margin: plan.margin,
  recommended: { cases: plan.recommended.cases, repeats: plan.recommended.repeats, reason: plan.recommended.reason },
  belowRecommended: plan.below_recommended,
  needsApproval: plan.needs_approval,
  capUsd: money(plan.cap_usd),
})
