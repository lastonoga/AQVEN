...
workspace в корне репозитория (113 пакетов на исходном срезе, 149 после добавления Codex 2026-09-18). Заявленная версия
...
Метод тот же, `latest` — на 2026-09-17; «`uv.lock`» — потребители в `uv.lock` workspace в корне репозитория, после добавления
